...
//        }
    ...
    public void queryByExample(){
        ...
        //기본 정책에서 null인것은 검색조건을 무시하지만
        //age는 primitive타입으로 null이 불가능하기에 검색조건에 들어간다. (0으로)
        //고로 age는 무시하도록 넣어준다.
    ...
    @Test
    public void projectionsWithInterface(){
        //given
        Team teamA = new Team("teamA");
        em.persist(teamA);
    ...
    @Test
    public void projectionsWithClass(){
        //given
        Team teamA = new Team("teamA");
        em.persist(teamA);
    ...
    public void 중첩구조projection(){
        ...
        //when
        //한건의 엔티티를 넘어가는 순간, 다른 엔티티는 모두 select해온다
